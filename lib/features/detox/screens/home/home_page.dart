...
import '../../../../data/services/databases/permission_storage_hive.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    final permissionStorage = context.read<PermissionStorageRepository>();

    if (permissionStorage.getPermission() == false) {
      permissionStorage.setPermission();
    }
  }
