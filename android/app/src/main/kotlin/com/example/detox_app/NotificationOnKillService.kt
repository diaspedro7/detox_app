...
class NotificationOnKillService: Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        try {
            ...
            val notificationBuilder = NotificationCompat.Builder(this, "com.example.detox_app")
            ...
            val channel = NotificationChannel("com.example.detox_app", name, importance).apply {
